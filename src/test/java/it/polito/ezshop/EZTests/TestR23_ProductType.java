...
public class TestR23_ProductType {
    ...
    @Test
    public void testValidCreateProductType() throws InvalidProductCodeException, InvalidQuantityException,
        InvalidPricePerUnitException, UnauthorizedException, InvalidProductDescriptionException {
        Integer prod_Id = ezshop.createProductType("chocolate", "12345678912237", 4, null);
        assertNotEquals(prod_Id, -1,0);
    }
    @Test 
    public void testInvalidCreateProductType() throws InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException, UnauthorizedException, InvalidUsernameException, InvalidPasswordException, InvalidRoleException{
    ...
    @Test 
    public void  testValidUpdateProduct() throws InvalidProductIdException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException, UnauthorizedException{
        List<ProductType> list = ezshop.getAllProductTypes();
        assertTrue(ezshop.updateProduct(prodId, "newDescription","12345678912237", 10, ""));
        
    }
    @Test 
    public void  testInvalidUpdateProduct() throws InvalidProductIdException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException, UnauthorizedException, InvalidUsernameException, InvalidPasswordException, InvalidRoleException{
        ...
        //assertNull(ezshop.updateProduct(this.prodId,"honey","2905911158926", 11, ""));//bar code doesn't change 

        assertFalse(ezshop.updateProduct(this.prodId+1,"honey","2905911158926", 11, ""));//no id found 
...
@Test
    public void testInvalidDeleteProductType() throws InvalidUsernameException, InvalidPasswordException, InvalidRoleException, InvalidProductIdException, UnauthorizedException{
        assertThrows(InvalidProductIdException.class,() -> {
    ...
    @Test
    public void testValidGetAllProductTypes() throws UnauthorizedException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException{
    ...
    @Test
    public void  testValidGetProductTypeByBarCode() throws InvalidProductCodeException, UnauthorizedException{
        
        assertNotNull(ezshop.getProductTypeByBarCode("2905911158926"));

    }
    @Test
    public void testInvalidGetProductTypeByBarCode() throws InvalidUsernameException, InvalidPasswordException, InvalidRoleException, InvalidProductCodeException, UnauthorizedException{
    ...
    @Test
    public void  testInvalidgetProductTypesByDescription() throws InvalidUsernameException, InvalidPasswordException, InvalidRoleException {
    ...
    @Test
    public void testValidUpdatePostion() throws InvalidProductIdException, InvalidLocationException, UnauthorizedException{
        assertTrue(ezshop.updatePosition(prodId, "300-abc-203"));
        assertTrue(ezshop.updatePosition(prodId, ""));
    }
    @Test
    public void testInValidUpdatePosition() throws InvalidUsernameException, InvalidPasswordException, InvalidRoleException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException, UnauthorizedException, InvalidProductIdException, InvalidLocationException{
    ...
    public void testInalidUpdateQuantity() throws InvalidProductIdException, UnauthorizedException, InvalidUsernameException, InvalidPasswordException, InvalidRoleException, InvalidProductDescriptionException, InvalidProductCodeException, InvalidPricePerUnitException{
