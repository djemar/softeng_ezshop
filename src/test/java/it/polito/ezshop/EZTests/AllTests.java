...
@SuiteClasses({TestR1_User.class, TestR2_Order.class, TestR3_Customer.class,
                ...
                TestR14_ReturnTransactionDb.class, TestR15_SaleTransactionDb.class,TestR17_SaleTransactionEZ.class,
                TestR16_ProductTypeDb.class, TestWBDB.class,TestR18_ReturnTransactionEZ.class, TestR19_OrderEZ.class})
